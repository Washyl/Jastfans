...
class SettingsController extends Controller
{
    ...
    public $availableSettings = [
        ...
        'tweet' => ['heading' => 'Social share settings', 'icon' => 'logo-twitter'],
    ];
    ...
    public function updateFlagSettings(UpdateUserFlagSettingsRequest $request)
    {
        ...
        if (! in_array($key, ['public_profile', 'paid-profile','enable_2fa', 'enable_geoblocking', 'open_profile', 'auto_post'])) {
    ...
    public function getAdditionalRouteAssets($settingRoute)
    {
        ...
        switch ($settingRoute) {
            ...
            case 'referrals':
                ...
                break;
            case 'tweet':
                $additionalAssets['js'][] = '/js/pages/settings/tweet.js';
                break;
        }
