...
Route::group(['middleware' => ['auth','verified','2fa']], function () {
    ...
    Route::get('revoke/authorization/twitter', 'Auth\TwitterController@revokeAuthorization')->name('twitter.revoke');
    Route::get('authorize/twitter', 'Auth\TwitterController@redirectToTwitter')->name('twitter.auth');
    Route::get('authorize/twitter/callback', 'Auth\TwitterController@handleTwitterCallback')->name('twitter.callback');
